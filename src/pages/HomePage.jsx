          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeUp className="space-y-8 relative z-10">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-300 max-w-xl leading-relaxed">
                  JellyByte Studios creates stylish indie games focused on challenge,
                  personality, and unforgettable gameplay moments.
                </p>
              </div>
            ...
            <FadeUp delay={0.2} className="relative flex justify-center lg:justify-end">
              <div className="relative w-full max-w-md">
                ...
                <div className="relative rounded-[2.5rem] border border-pink-500/20 bg-white/5 backdrop-blur-xl p-10 overflow-hidden">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-6">
                    From spine-chilling horror to heart-pounding adventure — we build worlds
                    you step into and can't stop thinking about long after you've left.
                  </p>

                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 rounded-full border border-white/10 text-sm">👻 Horror</span>
                    <span className="px-3 py-1 rounded-full border border-white/10 text-sm">⚔️ Adventure</span>
                    <span className="px-3 py-1 rounded-full border border-white/10 text-sm">🎮 Platformers</span>
                    <span className="px-3 py-1 rounded-full border border-white/10 text-sm">✨ & More</span>
                  </div>
              ...
              {games.map((game, index) => (
                ...
                >
                  ...
                  <div className="p-10 md:p-14 flex flex-col justify-center">
                    ...
                    <h4 className="font-bebas text-5xl mb-4">
                      {game.title}
                    </h4>
        ...
        <footer id="contact" className="border-t border-white/10 py-10 px-6">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex gap-6 text-sm text-gray-400">
              <a className="hover:text-pink-400">Twitter</a>
              <a className="hover:text-pink-400">Instagram</a>
              <a className="hover:text-pink-400">Discord</a>
              <a className="hover:text-pink-400">Steam</a>
            </div>
