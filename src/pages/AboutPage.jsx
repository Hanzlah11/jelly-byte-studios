  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-bebas text-6xl mt-3">
...
<div className="min-h-screen bg-[#090311] text-white overflow-hidden relative">
...
<div className="relative z-10">
  ...
  <div className="fixed top-8 left-8 z-50">
    ...
    <Link
      to="/"
      className="group flex items-center gap-3 rounded-full border border-white/10 bg-black/30 backdrop-blur-xl px-6 py-3 transition-all duration-300 hover:border-pink-500/40 hover:bg-white/10"
    >
      <ArrowLeft
        size={18}
    ...
    <div className="max-w-6xl mx-auto text-center">
      ...
      <FadeUp>
        ...
        <div className="inline-flex items-center gap-3 rounded-full border border-pink-500/20 bg-pink-500/10 px-6 py-3 mb-10">
          ...
          <span className="uppercase tracking-[0.3em] text-sm text-pink-300">
      ...
      <FadeUp delay={0.3}>
        ...
        <p className="max-w-3xl mx-auto mt-10 text-xl leading-relaxed text-gray-300">
          ...
          Every unforgettable game begins with passionate people.
          We are a small independent studio driven by creativity,
          innovation, and the ambition to build memorable gaming
          experiences that players will never forget.
        ...
        >
          ...
          <div className="relative z-10 px-12 py-24">
            ...
            <p className="max-w-3xl mx-auto mt-8 text-lg leading-relaxed text-gray-300">
              ...
              From gameplay programming and pixel art to marketing,
              web development, and production management, every member
              leads a core department while collaborating on every
              aspect of our games.
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <FadeUp>
              ...
              >
                ...
                <h3 className="font-bebas text-5xl mb-6">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  entertain, and inspire players. Every mechanic, visual,
                  and sound is crafted with care to deliver experiences that
            ...
            <FadeUp delay={0.15}>
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  We aspire to become a recognized indie game studio known
                  for originality, technical excellence, and unforgettable
                  gameplay. Every release is another step toward building a
                  lasting legacy for JellyByte Studios.
            ...
            <div className="hidden lg:block">
              ...
              <div className="grid grid-cols-5 gap-8">
                ...
                {[
                  ...
                  {
                    year: "Future",
                    title: "Growing JellyByte Studios",
                  },
                ].map((item, index) => (
              ...
              <div className="relative z-10 px-12 py-24 text-center">
                ...
                <div className="mt-14 flex flex-wrap justify-center gap-6">
                  ...
                  <motion.a
                    ...
                    className="rounded-2xl bg-gradient-to-r from-pink-500 to-orange-400 px-8 py-4 font-semibold shadow-xl shadow-pink-500/30"
